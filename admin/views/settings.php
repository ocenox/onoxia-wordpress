...
$widget_url = get_transient('onoxia_widget_url') ?: '';
...
// Sync settings
$sync_pages   = get_option('onoxia_sync_pages');
$sync_llms    = get_option('onoxia_sync_llms');
$sync_sitemap = get_option('onoxia_sync_sitemap');
$sync_products = get_option('onoxia_sync_products');

// Cron URL
$cron_url = home_url('?onoxia_cron=1&secret=' . wp_hash('onoxia_cron_secret'));
?>
                ...
                <table class="widefat striped" style="margin-top:12px;">
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <?php if (!empty($token)) : ?>
                                    ...
                                    <code style="margin-left:6px;"><?php echo esc_html($token_preview); ?></code>
                                <?php else : ?>
                        ...
                        <tr>
                            ...
                            <td><code><?php echo esc_html($widget_url); ?></code></td>
                        </tr>
                        <?php endif; ?>
                        <tr>
                ...
                <table class="widefat striped">
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <span class="onoxia-badge <?php echo $sync_pages ? 'onoxia-badge-ok' : 'onoxia-badge-off'; ?>">
                                    <?php echo $sync_pages ? esc_html__('Yes', 'onoxia') : esc_html__('No', 'onoxia'); ?>
                                </span>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <span class="onoxia-badge <?php echo $sync_llms ? 'onoxia-badge-ok' : 'onoxia-badge-off'; ?>">
                                    <?php echo $sync_llms ? esc_html__('Yes', 'onoxia') : esc_html__('No', 'onoxia'); ?>
                                </span>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <span class="onoxia-badge <?php echo $sync_sitemap ? 'onoxia-badge-ok' : 'onoxia-badge-off'; ?>">
                                    <?php echo $sync_sitemap ? esc_html__('Yes', 'onoxia') : esc_html__('No', 'onoxia'); ?>
                                </span>
                            </td>
                        </tr>
                        <?php if ($has_woo) : ?>
                        <tr>
                            ...
                            <td>
                                <span class="onoxia-badge <?php echo $sync_products ? 'onoxia-badge-ok' : 'onoxia-badge-off'; ?>">
                                    <?php echo $sync_products ? esc_html__('Yes', 'onoxia') : esc_html__('No', 'onoxia'); ?>
                                </span>
                            </td>
                        </tr>
                        <?php endif; ?>
            ...
            <div class="onoxia-card">
                <div style="display:flex;justify-content:space-between;align-items:center;">
                    ...
                    <button type="button" id="onoxia-sync-btn" class="button button-primary"
                            <?php echo empty($site_uuid) ? 'disabled' : ''; ?>>
